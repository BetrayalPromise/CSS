...
- (void)viewDidLoad {
    ...
    [showTableView registerReuseCellClass:[Custom1Cell class]];
...
- (nonnull UITableViewCell *)tableView:(nonnull UITableView *)tableView cellForRowAtIndexPath:(nonnull NSIndexPath *)indexPath {
    Custom1Cell * cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([Custom1Cell class])];
