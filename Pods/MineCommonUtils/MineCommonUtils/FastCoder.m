...
#define FC_ASSERT_FITS(length, offset, total)                                                                                                                                                                                                            \
    {                                                                                                                                                                                                                                                    \
...
#define FC_READ_VALUE(type, offset, input, total)                                                                                                                                                                                                        \
    type value;                                                                                                                                                                                                                                          \
    {                                                                                                                                                                                                                                                    \
...
#define FC_ALIGN_OUTPUT(type, output)                                                                                                                                                                                                                    \
    {                                                                                                                                                                                                                                                    \
        ...
        if (align)                                                                                                                                                                                                                                       \
            [output increaseLengthBy:sizeof(type) - align];                                                                                                                                                                                              \
    }
...
static id FCReadRawString(__unsafe_unretained FCNSDecoder *decoder) {
    ...
    if (length > 1) {
        string = CFBridgingRelease(CFStringCreateWithBytes(NULL, decoder->_input + *decoder->_offset, (CFIndex) length - 1, kCFStringEncodingUTF8, false));
    } else {
        string = @"";
    }
...
static id FCReadMutableDictionary(__unsafe_unretained FCNSDecoder *decoder) {
    const CFDictionaryKeyCallBacks keyCallbacks = {
        kCFTypeDictionaryKeyCallBacks.version, kCFTypeDictionaryKeyCallBacks.retain, kCFTypeDictionaryKeyCallBacks.release, kCFTypeDictionaryKeyCallBacks.copyDescription, &FCEqualityCallback, &FCHashCallback};

    const CFDictionaryValueCallBacks valueCallbacks = {
        kCFTypeDictionaryKeyCallBacks.version, kCFTypeDictionaryKeyCallBacks.retain, kCFTypeDictionaryKeyCallBacks.release, kCFTypeDictionaryKeyCallBacks.copyDescription, &FCEqualityCallback,
    };
...
static id FCReadRect(__unsafe_unretained FCNSDecoder *decoder) {
    FC_ALIGN_INPUT(Float64, *decoder->_offset);
    CGRect rect = {{(CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder)}, {(CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder)}};
...
static id FCReadAffineTransform(__unsafe_unretained FCNSDecoder *decoder) {
    FC_ALIGN_INPUT(Float64, *decoder->_offset);
    CGAffineTransform transform = {(CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder),
                                   (CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder)};
...
static id FCRead3DTransform(__unsafe_unretained FCNSDecoder *decoder) {
    FC_ALIGN_INPUT(Float64, *decoder->_offset);
    CGFloat transform[] = {(CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder),
                           (CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder),
                           (CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder), (CGFloat) FCReadRawDouble(decoder)};
...
static id FCReadNSCodedObject(__unsafe_unretained FCNSDecoder *decoder) {
    ...
    if ([decoder->_propertyDictionaryPool count]) {
        ...
        const CFDictionaryKeyCallBacks stringKeyCallbacks = {0, NULL, NULL, NULL, FCEqualityCallback, FCHashCallback};
...
+ (id)objectWithData:(NSData *)data {
    static FCTypeConstructor *constructors[] = {FCReadNil,
                                                FCReadNull,
                                                FCReadAlias8,
                                                FCReadAlias16,
                                                FCReadAlias32,
...
+ (id)propertyListWithData:(NSData *)data {
    static FCTypeConstructor *constructors[] = {NULL,
                                                FCReadNull,
                                                FCReadAlias8,
                                                FCReadAlias16,
                                                FCReadAlias32,
...
- (void)FC_encodeWithCoder:(__unsafe_unretained FCNSCoder *)coder {
    if (FCWriteObjectAlias(self, coder))
        return;
...
- (void)FC_encodeWithCoder:(__unsafe_unretained FCNSCoder *)coder {
    if ([self classForCoder] == [NSMutableString class]) {
        ...
        if (FCWriteStringAlias(self, coder))
            return;
...
- (void)FC_encodeWithCoder:(__unsafe_unretained FCNSCoder *)coder {
    ...
    [self enumerateRangesUsingBlock:^(__unused NSRange range, __unused BOOL *stop) { rangeCount++; }];
...
static id FCReadRect_2_3(__unsafe_unretained FCNSDecoder *decoder) {
    CGRect rect = {{(CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder)}, {(CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder)}};
    NSValue *value = [NSValue valueWithBytes:&rect objCType:@encode(CGRect)];
    FCCacheParsedObject(value, decoder->_objectCache);
    return value;
}
...
static id FCReadAffineTransform_2_3(__unsafe_unretained FCNSDecoder *decoder) {
    CGAffineTransform transform = {(CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder),
                                   (CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder)};
    NSValue *value = [NSValue valueWithBytes:&transform objCType:@encode(CGAffineTransform)];
    FCCacheParsedObject(value, decoder->_objectCache);
    return value;
}
...
static id FCRead3DTransform_2_3(__unsafe_unretained FCNSDecoder *decoder) {
    CGFloat transform[] = {(CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder),
                           (CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder),
                           (CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder),
                           (CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder), (CGFloat) FCReadRawDouble_2_3(decoder)};
    NSValue *value = [NSValue valueWithBytes:&transform objCType:@encode(CGFloat[16])];
    FCCacheParsedObject(value, decoder->_objectCache);
...
static id FCReadObject_2_3(__unsafe_unretained FCNSDecoder *decoder) {
    static FCTypeConstructor *constructors[] = {FCReadNull_2_3,
                                                FCReadAlias_2_3,
                                                FCReadString_2_3,
