...
/**
 ...
 @param keyPath item.keyPath 项求和
 @return 求和总数
 */
...
/**
 ...
 @param other 其他数组
 @param weight 重复时的保留权重
 @param lowerLimit 最低保留数
 @param upperLimit 最高保留数
 @return 交集
 */
