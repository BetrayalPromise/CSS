...
static YGSize YGMeasureView(YGNodeRef node, float width, YGMeasureMode widthMode, float height, YGMeasureMode heightMode) {
...
static CGFloat YGRoundPixelValue(CGFloat value) {
    ...
    dispatch_once(&onceToken, ^() { scale = [UIScreen mainScreen].scale; });
